...
import { centrixlogo, centrixsymbol, centrixwhitelogo, robotbg, smallrobotbg } from '../assets';
...
const MobileDesign = () => (
  <div className="flex flex-col w-full min-h-screen">
    ...
    >
      <img src={centrixwhitelogo} alt="Centrix Logo" className="w-20 sm:w-24" />
    </div>
    ...
    <div className="flex-1 flex flex-col justify-between items-center py-4 sm:py-6 px-4 sm:px-6 text-center">
      ...
      <img src={centrixsymbol} alt="Centrix Symbol" className="w-10 sm:w-12" />
